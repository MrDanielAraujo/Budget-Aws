...
import funcionarioValidator from './funcionario-form-validator.json';
...
export class FuncionarioFormComponent implements OnInit{
  ...
  protected crud = inject(CrudForm<Funcionario>);
   ...
   */
  ngOnInit(): void {
    this.crud.module = "funcionario";
    this.crud.form.errorMessage.validatorMessageForm = funcionarioValidator;
    this.crud.code = this.code;
    this.crud.dataChange.pipe(take(1)).subscribe((value) => this.data = value as Funcionario );
    this.crud.form.formGroup = this.fb.group({
      Id:[null],
      Nome:[null, [Validators.required]],
      IdCentroCusto: [null],
      IdFuncionarioContratacao: [null],
      IdFuncionarioCargo: [null],
