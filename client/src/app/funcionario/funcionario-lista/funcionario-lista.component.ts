...
export class FuncionarioListaComponent implements OnInit {
  ...
  protected dataList?: Funcionario[];
   ...
   */
  ngOnInit(): void {
    this.crud.module = this.crud.sessionKey = "funcionario";
  ...
  private actionAfterInitList() {
    this.crud.dataChange.subscribe((value: Funcionario[]) => this.setDataList(value))
  }
  private setDataList(value: Funcionario[]) {
    this.dataList = value;
